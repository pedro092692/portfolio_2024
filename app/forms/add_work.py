...
class AddWork(FlaskForm):
    ...
    full_width = SelectField('Full width for this work ?', choices=[('0', 'False'), ('1', 'True')])
    work_position = SelectField('Work Display Position', choices=[(str(i), str(i)) for i in range(1, 15)])
